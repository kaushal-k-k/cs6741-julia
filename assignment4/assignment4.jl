...
begin
	...
	n = 1
	for i in 1:40
		if(1-cdf(Normal(100 * i , 30 * i^(1/2)),2999.5) >= 0.95)
			n = i
			break
		end
	end
...
# original distribution is discrete so 2999.5 is taken insted of 3000
probability_to_survive = 1-cdf(Normal(100 *n , 30 * n^(1/2)),2999.5)
...
# ╔═╡ 0ff8be4f-4330-476a-a227-87449ffe606a
plot(D2)
